...
data = {
    'members':
        [{'name': 'iripuga', 'user_id': 689399469090799848, 'status': 'on'}, 
         ...
         {'name': 'table_slot1', 'user_id': 1, 'status': 'on'},  #tri karte na sredini mize
         {'name': 'table_slot2', 'user_id': 2, 'status': 'on'},
         {'name': 'table_slot3', 'user_id': 3, 'status': 'on'}],
    'roles':
       [{'name': 'VILLAGER', 'description': 'The Villager has no special ability, but he is definitely not a werewolf.', 'night_order': None},  #lohk jih kr tuki razporediš po zaporednih številkah. Če se nč z vlogo ne zgodi je order None
